      ...
      AUTO_tester: begin
        if (M_auto_out_state == 1'h0) begin
          ...
          case (M_auto_out_state)
            ...
            2'h2: begin
              M_seg_values[4+11-:12] = 12'h278;
            end
            2'h3: begin
              M_seg_values[4+11-:12] = 12'h166;
            end
            3'h4: begin
              M_seg_values[4+11-:12] = 12'h94a;
            end
            3'h5: begin
              M_seg_values[4+11-:12] = 12'hcb5;
            end
            3'h6: begin
              M_seg_values[4+11-:12] = 12'hd88;
            end
          endcase
