...
module au_top_0 (
  ...
  wire [7-1:0] M_segp1_seg;
  wire [2-1:0] M_segp1_sel;
  reg [10-1:0] M_segp1_values;
  multi_seven_seg_6 segp1 (
    .clk(clk),
    .rst(rst),
    .values(M_segp1_values),
    .seg(M_segp1_seg),
    .sel(M_segp1_sel)
  );
  wire [7-1:0] M_segp2_seg;
  wire [2-1:0] M_segp2_sel;
  reg [10-1:0] M_segp2_values;
  multi_seven_seg_6 segp2 (
    .clk(clk),
    .rst(rst),
  ...
  wire [7-1:0] M_segrounds_seg;
  wire [2-1:0] M_segrounds_sel;
  reg [10-1:0] M_segrounds_values;
  multi_seven_seg_6 segrounds (
    .clk(clk),
    .rst(rst),
    .values(M_segrounds_values),
    .seg(M_segrounds_seg),
    .sel(M_segrounds_sel)
  );
  ...
  always @* begin
    ...
    usb_tx = usb_rx;
    seven_seg_p1_sel = 4'hf;
    seven_seg_p1_seg = 4'hf;
    seven_seg_p2_sel = 4'hf;
    seven_seg_p2_seg = 4'hf;
    seven_seg_rounds_sel = 4'hf;
    seven_seg_rounds_seg = 4'hf;
    M_segp1_values = 10'h000;
    seven_seg_p1_seg = ~M_segp1_seg;
    seven_seg_p1_sel = ~M_segp1_sel;
    M_segp2_values = 10'h000;
    seven_seg_p2_seg = ~M_segp2_seg;
    seven_seg_p2_sel = ~M_segp2_sel;
    M_segrounds_values = 10'h000;
    seven_seg_rounds_seg = ~M_segrounds_seg;
    seven_seg_rounds_sel = ~M_segrounds_sel;
